...
export default function RegisterPage() {
  ...
  // Handle registrasi dengan Google
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    // Simulasi registrasi berhasil (belum ada backend)
    console.log('Registrasi dengan data:', formData)
        ...
        <div className="relative z-10 flex flex-col justify-center p-16 text-white w-full">
          ...
          <div>
            ...
            <p className="text-xl text-white/80 leading-relaxed max-w-md">
              Aplikasi ini berguna untuk mentracking aktivitas secara berkala
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8 py-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Daftar untuk mulai tracking aktivitas Anda
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-300 transform hover:scale-[1.02]"
              >
                Buat Akun
              </button>
            </form>
